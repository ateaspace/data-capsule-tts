...
# Point the package towards Python 3 by default (for the Meson build system)
export PYTHON="${ESPEAKEDIT_NG_HOME_INSTALLED}/bin/python3"
export PATH="${ESPEAKEDIT_NG_HOME_INSTALLED}/bin/meson:${PATH}"
