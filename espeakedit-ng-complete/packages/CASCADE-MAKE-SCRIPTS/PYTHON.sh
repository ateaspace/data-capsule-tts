...
export CFLAGS="$CFLAGS -I$prefix/include -I$opensslprefix/include"
export CPPFLAGS="$CPPFLAGS -I$prefix/include -I$opensslprefix/include"
export CXXFLAGS="$CXXFLAGS -I$prefix/include -I$opensslprefix/include"
