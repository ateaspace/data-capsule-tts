...
# export GLIB_LIBS="-L${SCROT_HOME_INSTALLED}/lib/x86_64-linux-gnu -lglib-2.0"
# export GLIB_CFLAGS="-I${SCROT_HOME_INSTALLED}/include/glib-2.0 -I${SCROT_HOME_INSTALLED}/lib/x86_64-linux-gnu/glib-2.0/include"
...
opt_run_configure $force_config $auto_config $package $version $prefix --with-internal-glib
